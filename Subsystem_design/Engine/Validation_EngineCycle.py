...
class Valid_Engine(Constants):
    ...
    def true_vals_TO(self, p0, mf_airfuel):  # self, p0, W_HPC, mf_airfuel
        self.v0_real = 0   # [m/s]
        self.T00_real = 288.15 # [K]
        self.p00_real = 1.01325 * 10**5 # [Pa]
        self.T02_real = 288.15 # [Pa]
        self.p02_real = 0.98285 * 10**5 # [Pa]
        self.T021_real = 319.2615 # [K]
        self.p021_real = 1.37599 * 10**5 # [Pa]
        self.T013_real = 319.3615 # [K]
        self.p013_real = 1.37599 * 10**5 # [Pa]
        self.T025_real = 394.92855 # [K]
        self.p025_real = 2.75199 * 10**5 # [Pa]
        self.T03_real = 811.34892 # [K]
        self.p03_real = 32.8312 * 10**5 # [Pa]
        self.T04_real = 1630.39416 # [K]
        self.p04_real = 30.86133 * 10**5 # [Pa]
        self.T045_real = 1137.72117 # [K] named TT49
        self.p045_real = 8.06183 * 10**5 # [Pa] named PT49
        self.T05_real = 745.99176 # [K] named TT6 (there's a T54)
        self.p05_real = 1.26715 * 10**5 # [Pa] named PT6 (there's a PT54)
        self.T07_real = 745.99176 # [K]
        self.p07_real = 1.25448 * 10**5 # [Pa]
        self.T8_real = 706.08318 # [K]
        self.p8_real = 1.01325 * 10**5 # [Pa]
        self.v8_real = 298.77282 # [m/s]
        self.T016_real = 319.3615 # [K]
        self.p016_real = 1.36223 * 10**5 # [Pa]
        self.T18_real = 293.5103 # [K]
        self.p18_real = 1.01325 * 10**5 # [Pa]
        self.v18_real = 228.47984 # [m/s]
        self.Thrust_real = 119593.54 # [N]

        self.OPR_real = 33.404 # [-]
...
if __name__ == "__main__":
    ...
    for i in index:
        ...
        cycle.cycle_analysis(aircraft='neo', i=i)
        e = 0.1

        if i == 4:
            val.true_vals_cruise(const.p0[i], cycle.mf_airfuel)
        elif i == 2:
            val.true_vals_TO(const.p0[i], cycle.mf_airfuel)
        ...
        print('Error in thrust: ', (cycle.T_total - val.Thrust_real) / val.Thrust_real)
