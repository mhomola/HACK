...
class DataFrame:
    def __init__(self):
        self.neo =\
            pd.DataFrame(data=np.array([['M0', 0.029, 0.12, 0.497, 0.78, 0.47, 0.029, 0],
                                        ['h', 0, 0, 5800, 11600, 5800, 0, 0],
                                        ['Thrust', 14000, 120000, 80000, 19000, 80000, 14000, 5000],
                                        ['A_eff/fan', 3.5, 3.5, 1, 0.8, 1.05, 4.2, 4.4], # M2 = 0.5, new Mach
                                        ...
                                        ['T04', 1127, 1547.39, 1544.847, 1300.304, 1544.847, 1123.5, 900.39],
                                        ['eta_LPT', 0.95, 0.94, 0.94025, 0.9405, 0.94025, 0.94, 0.94],
                                        ['eta_HPT', 0.95, 0.94, 0.9364, 0.9328, 0.9364, 0.94, 0.94],
                                        ...
                                        ['eta_nozzle', 0.985, 0.98, 0.9809, 0.9818, 0.9809, 0.98, 0.98],
                                        ['PR_noz_core', 0.992, 0.99, 0.98772, 0.985443, 0.98772, 0.99, 0.99],
                                        ['PR_noz_fan', 0.992, 0.99, 0.988722, 0.987444, 0.988722, 0.99, 0.99],
                                        ['mr_h2', 0, 0, 0, 0, 0, 0, 0],
        ...
        self.hack = \
            pd.DataFrame(data=np.array([['M0', 0.038, 0.12, 0.497, 0.78, 0.47, 0.038, 0],
                                        ...
                                        # ['T04', 1675, 1675, 1590, 1505, 1593, 1675, 1675], # +5K/year for 9 years (from article)
                                        # ['T04', 1715, 1715, 1630, 1545, 16323, 1715, 1715],  # +5K/year for 17 years (from article)
                                        ['T04', 1280, 1632.39, 1629.847, 1385.304, 1629.847, 1208.5, 985.39],
                                        ...
                                        ['D_fan', 83, 83, 83, 83, 83, 83, 83]], dtype="object"),
                         columns=['parameter', 'taxi_out', 'take_off', 'climb', 'cruise', 'approach', 'taxi_in', 'idle'])
