...
class DataFrame:
    def __init__(self):
        ...
        #                                 ['Thrust', 14000-0.07*792.557, 120000-0.07*33480.94606, 120000-0.07*33480.94606, 46500-0.07*40265.01961, 46500-0.07*40265.01961,
        ...
        #                                 # Idle and taxi are for M=0.4, the rest for M=0.5
        #                                 ['A_eff/fan', 3.5, 2.9, 1.8, 1.65, 1.6, 0.8, 0.8, 1.85, 2, 2.15, 3.65]]),
        #                  columns=['parameter', 'taxi_out', 'take_off1', 'take_off2',  'climb1', 'climb2', 'cruise1', 'cruise2', 'approach1', 'approach2', 'taxi_in', 'idle'])

        self.common_data = \
            pd.DataFrame(data=np.array([['M0', 0.038,0.1439,0.2495,0.267,0.2864,0.78,0.78,0.24,0.22,0.17,0.01],
                                        ['h', 0,0,0,450,900,11600,11600,900,450,0,0],
                                        ['Thrust',29518.49,232017.71,129126.15, 125456.20,118603.75,
                                        78063.96, 19000-0.07-0.07*40572.21543,34000-0.07*127934.76422,34000-0.07*127934.76422, 14000-0.07*12162.0246,5000],
                                        ['A_eff/fan', 3.5,2.9, 1.8,1.7,1.6,0.8, 0.8,1.85,2.,2.6,3.65]]),
                         columns=['parameter', 'taxi_out', 'take_off1','take_off2', 'climb1','climb2', 'cruise1','cruise2', 'approach1','approach2', 'taxi_in', 'idle'])
        # self.common_data_hack = \
        #     pd.DataFrame(data=np.array([['M0', 0.038,0.1439,0.2495,0.267,0.2864,0.78,0.78,0.24,0.22,0.17,0.01],
        #                                 ['h', 0,0,0,450,900,11600,11600,900,450,0,0],
        #                                 ['Thrust',29518.49,120000-0.07*33480.94606,120000-0.07*33480.94606, 46500-0.07*40265.01961,46500-0.07*40265.01961,
        #                                 19000-0.07-0.07*40572.21543, 19000-0.07-0.07*40572.21543,34000-0.07*127934.76422,34000-0.07*127934.76422, 14000-0.07*12162.0246,5000],
        #                                 ['A_eff/fan', 3.5,2.9, 1.8,1.7,1.6,0.8, 0.8,1.85,2.,2.6,3.65]]),
        #                  columns=['parameter', 'taxi_out', 'take_off1','take_off2', 'climb1','climb2', 'cruise1','cruise2', 'approach1','approach2', 'taxi_in', 'idle'])
