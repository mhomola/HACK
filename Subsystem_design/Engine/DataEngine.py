...
class DataFrame:
    def __init__(self):
        ...
        self.common_data = \
            pd.DataFrame(
                data=np.array([ ['M0', 0.038, 0.12, 0.497, 0.78, 0.47, 0.038, 0.01],
        ...
        self.neo = \
            pd.DataFrame(data=np.array([['M0', 0.038, 0.12, 0.497, 0.78, 0.47, 0.038, 0.01],
                                        ['h', 0, 0, 5800, 11600, 5800, 0, 0],
                                        ['Thrust', 14000 - 0.03 * 792.557, 120000 - 0.07 * 33480.94606,
                                         46500 - 0.07 * 40265.01961,
                                         19000 - 0.07 * 40572.21543, 35000 - 0.07 * 12793.476422,
                                         14000 - 0.07 * 12162.0246, 5000],
                                        ['A_eff/fan', 3.5, 3.5, 1, 0.8, 1.05, 3.5, 3.65],
                                        # M2 = 0.5, new Mach # 3.5/4.2
