...
# Assumption: storing H2 at 1.2 bar
p_tank = 120000                                   # Pressure in tank for liquid H2                     [Pa]
p_tank_g = 35000000                               # Pressure in tank for gas H2                        [Pa]
T_tank = 19.75                                    # Temperature in tank for liquid H2                  [K]
T_tank_g = 293.15                                 # Assuming H2 is stored at 20 C for gas              [K]
LH2_d = 71.1                                      # Mass density of liquid hydrogen                    [kg/m^3]
...
fuel_capacity_a320neo = 23859                     # Maximum Fuel capacity of A320neo           [l]
